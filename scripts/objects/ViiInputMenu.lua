---@class ViiInputMenu : Object
local ViiInputMenu, super = Class(Object)

function ViiInputMenu:init(length)
    ...
    self.input = {Game.wii_menu.mii.name}
...
function ViiInputMenu:onRemove()
    TextInput.endInput()
end
